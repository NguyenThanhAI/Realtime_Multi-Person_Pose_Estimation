...
def extract_parts(input_image, params, net, model_params):
    ...
    for m in range(len(multiplier)):
        ...
        heatmap = cv2.resize(heatmap, (0, 0), fx=model_params['stride'], fy=model_params['stride'], interpolation=cv.INTER_CUBIC)
